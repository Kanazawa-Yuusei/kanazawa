...
int main()
{
    ...
    do{
        ...
        else
        {
            ...
            //行ける座標の配列の最初のマスを現在の座標に更新する
            nowPos[0] = canGoPos[startIndex][0];
            nowPos[1] = canGoPos[startIndex][1];
            canGoPos[startIndex][0] = NULL;
            canGoPos[startIndex][1] = NULL;
            startIndex++;
        }
...
bool searchCanGoPos(int nowPosRow, int nowPosCol)
{
    ...
    cout << "行ける座標" << endl;
    for (int i = startIndex; i < canGoIndex; i++)
    {
        cout << "(";
        cout << canGoPos[i][0];
        cout << ", ";
